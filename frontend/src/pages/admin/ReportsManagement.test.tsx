...
vi.mock('../../components/admin/reports/SalesReport.js', () => ({
  default: () => <div>Sales Report Content</div>,
}));

vi.mock('../../components/admin/reports/PaymentStatusReport.js', () => ({
  default: () => <div>Payment Status Report Content</div>,
}));

vi.mock('../../components/admin/reports/ProductPopularityReport.js', () => ({
  default: () => <div>Product Popularity Report Content</div>,
}));

vi.mock('../../components/admin/reports/CustomerActivityReport.js', () => ({
